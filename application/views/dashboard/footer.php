  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2015 <a href="<?php echo base_url();?>" target="newtab">Baleromcr.com</a>.</strong> All rights reserved.
  </footer>
    ...
    <!-- jQuery Knob Chart -->
    <script src="<?php echo base_url();?>assets/dashboard/plugins/knob/jquery.knob.js"></script>
    <!-- daterangepicker -->
    ...
    <script src="<?php echo base_url();?>assets/dashboard/js/pages/dashboard.js"></script>  
