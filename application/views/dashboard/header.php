...
<html>
  <head>
    ...
    <title>cPanel BaleromCR | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>cPanel</b> Balerom!</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url();?>assets/dashboard/img/profile_160.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Andrés de la Espriella</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo base_url();?>assets/dashboard/img/profile_160.jpg" class="img-circle" alt="User Image">
                    <p>Andrés de la Espriella</p>
                  </li>
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-right">
                      <a href="<?php echo base_url();?>admin/logout" class="btn btn-danger btn-flat">Cerrar Sesión</a>
                    </div>
                  </li>
                </ul>
              </li>
