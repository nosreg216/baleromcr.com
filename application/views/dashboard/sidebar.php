...
<section class="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li><a href="<?php echo base_url();?>admin/"><i class="fa fa-dashboard"></i> <span>Principal</span></a></li>
    ...
    <li class="header">Gestión de la Página</li>
    <li><a href="<?php echo base_url();?>admin/banners"><i class="fa fa-desktop"></i> <span>Banners</span></a></li>
    <li><a href="<?php echo base_url();?>admin/security"><i class="fa fa-lock"></i> <span>Seguridad</span></a></li>
  </ul>
</section>
<!-- /.sidebar -->
</aside>